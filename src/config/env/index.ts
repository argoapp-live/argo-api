...
const development: IConfig = {
  ...
  flaskApi: {
    ...
    BASE_ADDRESS:
      process.env.INTERNAL_API_BASE_ADDRESS || "http://localhost:5000/",
  },
  paymentApi: {
...
const production: IConfig = {
  ...
  arweave: {
    CONTRACT_ID:
      process.env.ARWEAVE_CONTRACT_ID ||
...
const test: IConfig = {
  ...
  flaskApi: {
    HOST_ADDRESS:
      process.env.INTERNAL_API || "http://35.194.19.236:5000/request_build",
    BASE_ADDRESS:
      process.env.INTERNAL_API_BASE_ADDRESS || "http://35.194.19.236:5000/",
  },
  paymentApi: {
    HOST_ADDRESS: "http://localhost:3001/payments",
  ...
  argoReact: {
    BASE_ADDRESS:
      process.env.INTERNAL_FE_BASE_ADDRESS || "http://35.194.19.236:3000/",
  },
  domainResolver: {
    BASE_ADDRESS: process.env.DOMAIN_RESOLVER_URL || "http://localhost:3000",
    SECRET: process.env.DOMAIN_SECRET || "",

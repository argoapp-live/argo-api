...
export interface IDeploymentService {
    create(topic: string, projectId: string, configurationId: string, deploymentEnv: any, commitId: string, commitMessage: string, paymentId: string): Promise<IDeployment>;
    ...
    allDeploymentsInSubscription(fromTimestamp: number, projectIds: Array<string>): Promise<Array<IDeployment>>;
}